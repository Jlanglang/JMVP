...
import com.baozi.jmvp.ui.view.IUIView;
...
class DefuatlToolbarHelperImplV1 extends BaseToolBarHelperImpl {
    ...
    public void initToolbar() {
        ...
        if (vs_toolbar != null) {
            ...
            vs_toolbar.setLayoutInflater(LayoutInflater.from(mRootView.getContext()));
            mToolbar = (LinearLayout) vs_toolbar.inflate();
        } else {
            mToolbar = (LinearLayout) mRootView.findViewById(R.id.tl_costom);
        }
