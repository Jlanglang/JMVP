...
public class BindViewHolder {
    ...
    public BindViewHolder(Context context, View view) {
        mContext = context;
        mConvertView = view;
        mViews = new SparseArray<View>();
    }

    public static BindViewHolder bind(Context context, View view) {
        return new BindViewHolder(context, view);
    }
     ...
     * @return
     */
    public BindViewHolder setText(int viewId, String text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        return this;
    }

    public BindViewHolder setImageResource(int viewId, int resId) {
        ImageView view = getView(viewId);
        view.setImageResource(resId);
        return this;
    }

    public BindViewHolder setImageBitmap(int viewId, Bitmap bitmap) {
        ImageView view = getView(viewId);
        view.setImageBitmap(bitmap);
        return this;
    }

    public BindViewHolder setImageDrawable(int viewId, Drawable drawable) {
        ImageView view = getView(viewId);
    ...
    public BindViewHolder setTextColorRes(int viewId, int textColorRes) {
        TextView view = getView(viewId);
    ...
    public BindViewHolder linkify(int viewId) {
        TextView view = getView(viewId);
    ...
    public BindViewHolder setRating(int viewId, float rating) {
        RatingBar view = getView(viewId);
        view.setRating(rating);
        return this;
    }

    public BindViewHolder setRating(int viewId, float rating, int max) {
        RatingBar view = getView(viewId);
        view.setMax(max);
        view.setRating(rating);
        return this;
     ...
     * 关于事件的
     */
    public BindViewHolder setOnClickListener(int viewId,
    ...
    public BindViewHolder setOnTouchListener(int viewId,
    ...
    public BindViewHolder setOnLongClickListener(int viewId,
