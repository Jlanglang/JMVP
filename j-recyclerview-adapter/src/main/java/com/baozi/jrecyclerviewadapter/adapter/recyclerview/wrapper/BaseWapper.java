package com.baozi.jrecyclerviewadapter.adapter.recyclerview.wrapper;

import android.support.v7.widget.RecyclerView;
import android.view.ViewGroup;

import com.baozi.jrecyclerviewadapter.adapter.recyclerview.ItemManager;
...
public class BaseWapper<T> extends SimpleRecyclerAdapter<T> {

    protected SimpleRecyclerAdapter<T> mAdapter;

    public BaseWapper(SimpleRecyclerAdapter<T> adapter) {
        mAdapter = adapter;
